...
\subsection*{Moders Kald}\addcontentsline{toc}{subsection}{Moders Kald}
Druiden har mulighed for at snakke med et af elementener pr. spilgang.

\subsection*{Naturens Essens}\addcontentsline{toc}{subsection}{Naturens Essens}
...
\subsection*{Naturens Magi Niv. 3}\addcontentsline{toc}{subsection}{Naturens Magi Niv. 3}
...
\subsection*{Urtekundskab}\addcontentsline{toc}{subsection}{Urtekundskab}
Du vil nu altid finde en urt i urtedalen.\todo{Dette er en duplikering fra Alkymist, og de gør noget forskelligt.}